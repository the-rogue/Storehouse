...
public class NewSlotAdapter extends Slot {
	
	private static IInventory emptyInventory = new InventoryBasic("[Null]", true, 0);
	private final IInventorySlot slot;
	
	public NewSlotAdapter (IInventorySlot slot) {
	...
	public boolean isSameInventory (Slot other) {
		return other instanceof NewSlotAdapter && ((NewSlotAdapter) other).slot == this.slot;
	}
}
