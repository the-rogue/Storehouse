...
public class ContainerPotionInjector extends ContainerBase {
	
	public ContainerPotionInjector (IInventory playerInv, TilePotionInjector teInv) {
		super(playerInv, teInv);
		IInventoryItemHandler inventory = teInv.getCapability(GuiItemCapability.CAP, null, ModuleContext.GUI);
		this.addTESlot(new InventorySlot(inventory, 0, 80, 37));
	}
}
