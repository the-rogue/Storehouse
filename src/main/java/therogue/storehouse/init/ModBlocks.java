...
import therogue.storehouse.block.machine.BlockAlloyFurnace;
...
import therogue.storehouse.block.machine.BlockForge;
import therogue.storehouse.block.machine.BlockLiquidGenerator;
import therogue.storehouse.block.machine.BlockMultiblockController;
...
public class ModBlocks {
	...
	public static void preInit () {
		...
		burner = new BlockMultiblockController<TileBurner>("burner", new Supplier<TileBurner>() {
			
			@Override
			public TileBurner get () {
				return new TileBurner();
			}
		});
		carbonCompressor = new BlockMultiblockController<TileCarbonCompressor>("carbon_compressor", new Supplier<TileCarbonCompressor>() {
			
			@Override
			public TileCarbonCompressor get () {
	...
	public static BlockMultiblockController<TileBurner> burner;
	public static BlockMultiblockController<TileCarbonCompressor> carbonCompressor;/*
																					 ...
																					 * public static BlockCraftingCable crafting_cable; public static BlockShelfStocker shelf_stocker; public static BlockStockController stock_controller; public static BlockStockRequester stock_requester; public static
																					 * BlockStockTransfer
																					 ...
																					 * wireless_redstone_manager; public static BlockWirelessTransmitter wireless_transmitter; public static BlockWirelessReciever wireless_reciever; public static BlockBlackHoleStabiliser black_hole_stabiliser; public
																					 * static
