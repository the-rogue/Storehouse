...
public class BlockAlloyFurnace extends StorehouseBaseFacingMachine {
	...
	public TileEntity createNewTileEntity (World worldIn, int meta) {
		TileAlloyFurnace tile = new TileAlloyFurnace();
	...
	public boolean onBlockActivated (World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
		if (!world.isRemote)
		{
			player.openGui(Storehouse.instance, GuiHandler.ALLOYFURNACE, world, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
}
